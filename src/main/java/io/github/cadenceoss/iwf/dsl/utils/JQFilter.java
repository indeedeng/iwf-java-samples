...
/**
 * Note: Took this from <a href="https://github.com/temporalio/samples-java/blob/main/src/main/java/io/temporal/samples/dsl/utils/JQFilter.java">temporalio-samples</a>. All credit goes to them.
 *
 */
public class JQFilter {
  ...
  public JsonNode evaluateExpression(String expression, Object data) {

    try {
      JsonNode dataAsJson = OBJECT_MAPPER.valueToTree(data);
      ...
      expressionMap.get(toEvalExpression).apply(childScope, dataAsJson, result::add);
  ...
  public boolean evaluateBooleanExpression(String expression, Object data) {
    BooleanNode result = (BooleanNode) evaluateExpression(expression, data);
    return result.booleanValue();
  }

  public List<JsonNode> evaluateArrayExpression(String expression, Object data) {
